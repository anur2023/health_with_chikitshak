...
const Blogs = ()=>{
    const blogs = [
        {id:1,title: 'Check your health in a click',image:"/src/LoginAssets/about.jpg"},
        {id:2,title: 'Check your health in a click',image:"/src/LoginAssets/about.jpg"},
        {id:3,title: 'Check your health in a click',image:"/src/LoginAssets/about.jpg"},
    ]
    return(
        <>
