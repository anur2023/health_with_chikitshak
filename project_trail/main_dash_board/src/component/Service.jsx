...
<div className="md:px-14 py-16 max-w-screen-2xl mx-auto">
    ...
    <div className="text-center my-8">
        ...
        <img className="imgSize" src="/src/LoginAssests/1.png" alt="" />
        <img className="imgSize" src="/src/LoginAssests/2.png" alt="" />
        <img className="imgSize" src="/src/LoginAssests/3.png" alt="" />
        <img className="imgSize" src="/src/LoginAssests/4.png" alt="" />
        <img className="imgSize" src="/src/LoginAssests/5.png" alt="" />
        <img className="imgSize" src="/src/LoginAssests/6.png" alt="" />
        </div>
